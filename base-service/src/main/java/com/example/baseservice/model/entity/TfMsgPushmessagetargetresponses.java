...
@Getter
@Setter
@TableName("tf_msg_pushmessagetargetresponses")
public class TfMsgPushmessagetargetresponses implements Serializable {
    ...
    @TableField("pushmessagetargetid")
    private Long pushmessagetargetid;
