...
@Getter
@Setter
@TableName("chatthreadstates")
public class Chatthreadstates implements Serializable {
    ...
    @TableField("recipientlastreadmessageid")
    private Long recipientlastreadmessageid;
